...
This folder contains screenshots related to the configuration and testing of **Windows Deployment Services (WDS)** on Windows Server 2025. They provide visual proof of each configuration step namely: 
...
📸 **WDS Configuration Wizard Final Page** 
...
<img width="1920" height="909" alt="Client Machines Joined to Domain" src="https://github.com/user-attachments/assets/5980e1d4-6991-450d-a38b-3b505aaca29c" /><br />
...
# 📌 Notes  
- All screenshots were taken directly from the **homelab VMs** during setup.  
- Filenames are descriptive for easier mapping to the main documentation steps.  
- These screenshots serve as **visual evidence** of successful configuration and deployment.  
