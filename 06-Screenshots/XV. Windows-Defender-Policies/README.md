...
This section highlights the configuration and enforcement of the domain-wide windows defender policy applied through a dedicated GPO named Windows Defender Policy. The goal was to secure client machines and enforce antivirus protections.

---

## 1. GPO in Group Policy Management Console (GPMC)

Windows Defender Policy GPO applied at the domain level for all domain-joined computers.
...
📂 [`04-Security-Policies/V. Windows-Defender-Policies`](https://github.com/Hugh-Kumbi/Hugh-Kumbi-Active-Directory-Lab/blob/main/04-Security-Policies/V.%20Windows-Defender-Policies.md)
